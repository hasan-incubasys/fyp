...
<div id="main">
    <div id="textbox" ><input class="box" type="text" id="text" /><button type="button" id="buttonDesign">Ask Question</button></div>
    ...
    <div  id="ya-center-rail"  style="margin-left:200px;margin-right:191px;margin-top:-171px;">
        <div class="subcategorymain">
            <div class="navigation"><a class="sub1" href="#">All Categories</a></div>

            <a href="#" class="subdesign" >Beauty</a>
            <a href="#" class="subdesign" >Beauty</a>
            <a href="#" class="subdesign" >Beauty</a>
            <a href="#" class="subdesign" >Beauty</a>
            <a href="#" class="subdesign" >Beauty</a>
